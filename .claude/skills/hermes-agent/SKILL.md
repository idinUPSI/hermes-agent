...
description: Development conventions and patterns for hermes-agent. TypeScript project with freeform commits.
---

# Hermes Agent Conventions

> Generated from [idinUPSI/hermes-agent](https://github.com/idinUPSI/hermes-agent) on 2026-09-04
...
```text
Add Aider pair-programming skill
```
